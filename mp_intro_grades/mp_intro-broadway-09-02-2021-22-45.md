...
```
intro.cpp:55:11: warning: unused variable 'diffX' [-Wunused-variable]
      int diffX = centerX - x;
          ^
intro.cpp:30:7: warning: unused variable 'centerY' [-Wunused-variable]
...
This report was generated for **mv16** using **009cce6fa7843cd6a717010c7ad74038b9fe4465** (latest commit as of **September 2nd 2021, 10:45 pm**)
