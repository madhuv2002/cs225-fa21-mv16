...
==88== Command: ./test -r xml "List::insertFront\ size"
==88== 
==88== 
==88== HEAP SUMMARY:
...
==90== Command: ./test -r xml "List::insertBack\ size"
==90== 
==90== 
==90== HEAP SUMMARY:
==90==     in use at exit: 0 bytes in 0 blocks
==90==   total heap usage: 2,347 allocs, 2,347 frees, 268,272 bytes allocated
==90== 
...
==92== Command: ./test -r xml "List::insert\ contents"
==92== 
==92== 
==92== HEAP SUMMARY:
==92==     in use at exit: 0 bytes in 0 blocks
==92==   total heap usage: 2,343 allocs, 2,343 frees, 268,176 bytes allocated
==92== 
...
==94== Command: ./test -r xml "List::triplerotate\ basic"
==94== 
==94== 
==94== HEAP SUMMARY:
==94==     in use at exit: 0 bytes in 0 blocks
==94==   total heap usage: 2,351 allocs, 2,351 frees, 268,464 bytes allocated
==94== 
...
==96== Command: ./test -r xml "List::triplerotate\ simple"
==96== 
==96== 
==96== HEAP SUMMARY:
==96==     in use at exit: 0 bytes in 0 blocks
==96==   total heap usage: 2,355 allocs, 2,355 frees, 268,560 bytes allocated
==96== 
...
==98== Command: ./test -r xml "List::split\ simple"
==98== 
==98== 
==98== HEAP SUMMARY:
==98==     in use at exit: 0 bytes in 0 blocks
==98==   total heap usage: 2,205 allocs, 2,205 frees, 263,744 bytes allocated
==98== 
...
==101== Command: ./test -r xml "List::_destroy\ empty\ list"
==101== 
==101== 
==101== HEAP SUMMARY:
==101==     in use at exit: 0 bytes in 0 blocks
==101==   total heap usage: 2,355 allocs, 2,355 frees, 269,104 bytes allocated
==101== 
...
==103== Command: ./test -r xml "List::begin()\ returns\ an\ iterator\ to\ the\ front\ of\ the\ list"
==103== 
==103== 
==103== HEAP SUMMARY:
==103==     in use at exit: 0 bytes in 0 blocks
==103==   total heap usage: 2,359 allocs, 2,359 frees, 273,440 bytes allocated
==103== 
...
==105== Command: ./test -r xml "List::ListIterator::operator++\ advances\ the\ iterator\ (pre-increment)"
==105== 
==105== 
==105== HEAP SUMMARY:
...
==107== Command: ./test -r xml "List::ListIterator::operator++\ advances\ the\ iterator\ (post-increment)"
==107== 
==107== 
==107== HEAP SUMMARY:
==107==     in use at exit: 0 bytes in 0 blocks
==107==   total heap usage: 2,359 allocs, 2,359 frees, 275,840 bytes allocated
==107== 
...
==109== Command: ./test -r xml "List::ListIterator::operator++\ (post-increment)\ returns\ an\ un-incremented\ iterator"
==109== 
==109== 
==109== HEAP SUMMARY:
==109==     in use at exit: 0 bytes in 0 blocks
==109==   total heap usage: 2,359 allocs, 2,359 frees, 278,240 bytes allocated
==109== 
...
==111== Command: ./test -r xml "List::ListIterator::operator--\ moves\ the\ iterator\ backwards"
==111== 
==111== 
==111== HEAP SUMMARY:
...
==115== Command: ./test -r xml "List::ListIterator::end\ is\ reached"
==115== 
==115== 
==115== HEAP SUMMARY:
==115==     in use at exit: 0 bytes in 0 blocks
==115==   total heap usage: 2,352 allocs, 2,352 frees, 270,872 bytes allocated
==115== 
...
==117== Command: ./test -r xml "List::ListIterator::end\ is\ not\ ::begin\ in\ a\ non-empty\ list"
==117== 
==117== 
==117== HEAP SUMMARY:
==117==     in use at exit: 0 bytes in 0 blocks
==117==   total heap usage: 2,352 allocs, 2,352 frees, 273,272 bytes allocated
==117== 
...
This report was generated for **mv16** using **6fc908d146e9b588069ccbf8e58fae9126406b57** (latest commit as of **September 24th 2021, 8:10 pm**)
