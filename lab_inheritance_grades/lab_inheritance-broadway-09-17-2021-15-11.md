...
==78==    by 0x42BD87: ____C_A_T_C_H____T_E_S_T____10() (tests.cpp:134)
==78==    by 0x460CC2: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==78==    by 0x451416: Catch::TestCase::invoke() const (catch.hpp:10793)
==78==    by 0x45134C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==78==    by 0x44D8A6: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==78==    by 0x44BE7E: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==78==    by 0x455216: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==78==    by 0x453EB2: Catch::Session::runInternal() (catch.hpp:10149)
==78==    by 0x453B7A: Catch::Session::run() (catch.hpp:10106)
==78== 
==78== 64 bytes in 1 blocks are definitely lost in loss record 6 of 7
==78==    at 0x4C29EA3: malloc (vg_replace_malloc.c:309)
==78==    by 0x40475CB: operator new(unsigned long) (in /usr/local/lib/libc++abi.so.1.0)
==78==    by 0x407A94: Flower::Flower(Vector2 const&) (flower.cpp:38)
==78==    by 0x42BD87: ____C_A_T_C_H____T_E_S_T____10() (tests.cpp:134)
==78==    by 0x460CC2: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==78==    by 0x451416: Catch::TestCase::invoke() const (catch.hpp:10793)
==78==    by 0x45134C: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
This report was generated for **mv16** using **a7460f5f16bbb882bc9208f72a97d7179e1f052c** (latest commit as of **September 17th 2021, 3:12 pm**)
